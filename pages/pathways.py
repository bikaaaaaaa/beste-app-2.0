...
def main():
    ...
    if selected_pathway == "Atmungskette":
        ...
        st.markdown("<p style='text-align: center; font-family: Arial, sans-serif; font-size: 12px; color: #666; position: fixed; bottom: 10px; left: 50%; transform: translateX(-50%);'>Inspired by <a href='https://meditricks.de' target='_blank' style='color: #666; text-decoration: none;'>meditricks.de</a></p>", unsafe_allow_html=True)
