...
def main():
    ...
    if selected_pathway == "Atmungskette":
        ...
        st.markdown("<p style='text-align: right; font-family: Arial, sans-serif; font-size: 14px; color: #666666; position: fixed; bottom: 10px; right: 205px;'>Inspired by <a href='https://meditricks.de' target='_blank'>meditricks.de</a></p>", unsafe_allow_html=True)
