...
def main():
    ...
    if selected_pathway == "Atmungskette":
        ...
        st.markdown("<p style='text-align: center; font-family: Arial, sans-serif; font-size: 16px; position: fixed; bottom: 10px; transform: translateX(-50%);'>Inspired by <a href='https://meditricks.de' target='_blank' >meditricks.de</a></p>", unsafe_allow_html=True)
